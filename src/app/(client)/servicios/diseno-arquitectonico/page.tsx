			...
			<section className="border-b border-black/10 dark:border-white/10">
				<div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
					...
					>
						...
						>
							Anteproyecto, proyecto ejecutivo y coordinación BIM para asegurar
							factibilidad, calidad y precisión constructiva.
						</motion.p>
					</motion.div>
				</div>
			</section>
			...
			<section className="py-16 md:py-24">
				<div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
					...
					>
						{[
							{
								t: "Optimización de programa",
								d: "Brief claro y análisis de uso/flujo.",
							},
							{
								t: "Precisión ejecutiva",
								d: "Detalles y especificaciones alineadas a obra.",
							},
							{
								t: "Coordinación BIM",
								d: "Detección temprana de interferencias.",
							},
						].map((x) => (
							<motion.li
								key={x.t}
				...
				<div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
					...
					>
						{[
							...
							"Proyecto ejecutivo multidisciplinar",
							"Memorias, cómputos y especificaciones",
							"Modelado BIM y coordinación",
			...
			<section className="py-20 md:py-28 border-t border-black/10 dark:border-white/10">
				<div className="mx-auto max-w-[900px] px-4 sm:px-6 lg:px-8 text-center">
					<motion.h3
						...
						className="text-2xl md:text-3xl font-semibold"
					>
						¿Iniciamos tu diseño con GOSD CONSTRUCTOR?
					</motion.h3>
					<motion.div
						variants={stagger(0.12)}
						initial="hidden"
