...
const Navbar: React.FC = () => {
	...
	const navVariants = {
		hidden: { y: prefersReduced ? 0 : -8, opacity: prefersReduced ? 1 : 0 },
		show: {
			y: 0,
			opacity: 1,
					...
					className={[
						...
						scrolled
							...
							: [
									...
									"supports-[backdrop-filter]:bg-white/70 supports-[backdrop-filter]:dark:bg-black/70",
							  ].join(" "),
					].join(" ")}
					role="navigation"
				>
					...
					>
                        ...
                        ${
											...
											aria-haspopup={
												isServicios || isObras ? "menu" : undefined
											}
											aria-expanded={
												isServicios
													? servicesOpen
											...
											<AnimatePresence>
												{servicesOpen && (
													<motion.div
														...
														animate="show"
														exit="exit"
														className="absolute left-0 mt-2 w-[340px] rounded-xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-black/80 backdrop-blur-md shadow-lg overflow-hidden"
													>
														<div className="p-2">
															{servicios.map((s) => {
					...
					<div className="hidden lg:flex items-center gap-2">
						<Link
							href="/signin"
							className="inline-flex items-center rounded-md border border-black/15 dark:border-white/20 px-4 py-2 text-sm text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-black/20 dark:focus:ring-white/30"
							onClick={() => {
								setServicesOpen(false);
								setObrasOpen(false);
							}}
						...
						<Link
							href="/signup"
							className="inline-flex items-center rounded-md border border-transparent px-4 py-2 text-sm text-white bg-black dark:bg-white/10 dark:text-white hover:bg-black/80 dark:hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-black/20 dark:focus:ring-white/30"
							onClick={() => {
								setServicesOpen(false);
								setObrasOpen(false);
							}}
					...
					>
                        ...
                        ${
								...
								<li className="pt-2 flex items-center gap-2">
									<Link
										href="/signin"
										className="flex-1 inline-flex items-center justify-center rounded-md border border-black/15 dark:border-white/20 px-4 py-2 text-sm text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/10"
										onClick={() => setMobileOpen(false)}
									>
										Iniciar sesión
									</Link>
									<Link
										href="/signup"
										className="flex-1 inline-flex items-center justify-center rounded-md px-4 py-2 text-sm text-white bg-black dark:bg-white/10 dark:text-white hover:bg-black/80 dark:hover:bg-white/20"
										onClick={() => setMobileOpen(false)}
									>
										Crear cuenta
									</Link>
